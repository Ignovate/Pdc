...
class Cmsmart_AdminTheme_Block_Adminhtml_Block_Dashboard extends Mage_Adminhtml_Block_Template
{
    protected $_locale;
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('viewed',
                $this->getLayout()->createBlock('cmsmart_admintheme/adminhtml_block_dashboard_viewed')
        );
