 ...
 */
class Cmsmart_AdminTheme_Block_Adminhtml_Block_System_Config_Edit extends Mage_Adminhtml_Block_Widget
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('adminhtml.system.config.switcher', $this->getLayout()->createBlock('adminhtml/system_config_switcher'));
